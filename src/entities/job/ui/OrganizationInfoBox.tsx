 ...
 */
export function OrganizationInfoBox({ name, description, homepageLabel }: OrganizationInfoBoxProps) {
  return (
    <section className="flex flex-col gap-[20px] rounded-[16px] border border-[#e5e5e5] bg-white px-[24px] pt-[24px] pb-[32px]">
      <h2 className="text-[20px] leading-[1.4] font-semibold tracking-[-0.2px] text-black">기업 정보</h2>
      <div className="flex items-center gap-[16px]">
        <span className="size-[56px] shrink-0 rounded-[12px] border border-[#e5e5e5] bg-[#f5f5f5]" aria-hidden="true" />
        <div className="flex flex-col gap-[4px]">
          <p className="text-[16px] leading-[1.6] font-semibold tracking-[-0.16px] text-[#111]">{name}</p>
