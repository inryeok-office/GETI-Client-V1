...
interface StatusDialogProps {
  ...
  actionsGap?: 8 | 24;
  /** 카드 전체 너비(px). 버튼이 2개라 더 넓어야 하는 이탈 확인 모달은 380, 지원 취소 확인 모달은 480, 나머지는 320(기본값)이다. */
  width?: 320 | 380 | 480;
  /**
   * 아이콘 · 문구 블록의 너비. 기본값은 320/380 다이얼로그들처럼 272px로 고정하지만,
   * 지원 취소 확인 모달(480px)은 Figma에서 이 블록이 카드 너비만큼(w-full) 늘어나 있어 'full'로 지정한다.
   */
