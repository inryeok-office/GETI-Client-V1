...
/**
 * 공고 관리 목록 테이블. 표시만 담당한다 — 공고명은 `/admin/jobs/[jobId]` 상세 링크,
 * "수정"은 `/admin/jobs/[jobId]/edit`(Issue #205). "마감"·"삭제"는 클릭만 호출부로 올린다
 * (뮤테이션·확인 모달·토스트는 `AdminJobListPage`가 소유해 목록이 빈 상태로 바뀌어도 성공
 * 토스트가 유지된다, PR #208 코드리뷰 반영).
 *
